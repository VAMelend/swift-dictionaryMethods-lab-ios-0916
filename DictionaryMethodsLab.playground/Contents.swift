...
starWarsHeroes.append("Kylo Ren")
 ...
 */
// write your code here
let result = starWarsCharacters.updateValue("\(starWarsJedi)", forKey: "Jedi")
if result == nil {
 ...
 */
// write your code here
let remove = starWarsCharacters.removeValueForKey("Bounty Hunters")
if remove == nil {
